 ...
 * @version $Id$
 */
public class Or implements uk.co.jezuk.mango.BinaryPredicate
{
  public Or(uk.co.jezuk.mango.BinaryPredicate pred1, uk.co.jezuk.mango.BinaryPredicate pred2) { p1_ = pred1; p2_ = pred2; }
