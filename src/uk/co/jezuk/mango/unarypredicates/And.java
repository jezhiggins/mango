 ...
 * @version $Id$
 */
public class And implements uk.co.jezuk.mango.Predicate
{
  public And(uk.co.jezuk.mango.Predicate pred1, uk.co.jezuk.mango.Predicate pred2) { p1_ = pred1; p2_ = pred2; }
