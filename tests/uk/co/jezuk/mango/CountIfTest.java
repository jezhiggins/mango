...
public class CountIfTest  extends TestCase
{
  ...
  public void test1()
  {
    ...
    assertEquals(1, Algorithms.countIf(list, Bind.First(BinaryPredicates.EqualTo(), new Integer(5))));
    list.add(new Integer(5));
    list.add(new Integer(5));
    list.add(new Integer(5));
    list.add(new Integer(5));
    assertEquals(5, Algorithms.countIf(list, Bind.First(BinaryPredicates.EqualTo(), new Integer(5))));
  } // 
  ...
  public void test2()
  {
    ...
    assertEquals(9, Algorithms.countIf(list, Bind.First(BinaryPredicates.NotEqualTo(), new Integer(5))));
    list.add(new Integer(5));
    list.add(new Integer(5));
    list.add(new Integer(5));
    list.add(new Integer(5));
