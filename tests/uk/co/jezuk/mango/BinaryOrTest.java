...
public class BinaryOrTest  extends TestCase
{
  ...
  public void test1()
  {
    BinaryPredicate o = Mango.Or(new t(), new t());
    assertEquals(true, o.test(null, null));
  } // test1

  public void test2()
  {
    BinaryPredicate o = Mango.Or(new f(), new t());
    assertEquals(true, o.test(null, null));
  } // test2

  public void test3()
  {
    BinaryPredicate o = Mango.Or(new t(), new f());
    assertEquals(true, o.test(null, null));
  } // test3

  public void test4()
  {
    BinaryPredicate o = Mango.Or(new f(), new f());
